...
| **Quality Model factors and metrics** | Files used to congifure factors and metrics defined in the QRapids Quality Model |[File for Factors configuration](https://github.com/q-rapids/qrapids-eval/blob/master/projects/default/factors.properties), [Files for Metrics configuration](https://github.com/q-rapids/qrapids-eval/tree/master/projects/default/metrics) | Fraunhofer & UoO |
