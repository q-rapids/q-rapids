...
| **QR Patterns Catalogue** | [QR patterns catalogue used for generating QRs](https://github.com/q-rapids/qrapids-qr_generation/blob/master/src/main/resources/QRcatalog.json) | | UPC|
