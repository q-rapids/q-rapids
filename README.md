...
| **Quality Model factors and metrics** | Files used to congifure factors and metrics defined in the QRapids Quality Model | [How to configure factors and metrics](https://github.com/q-rapids/qrapids-eval#configuration) | Fraunhofer & UoO |
